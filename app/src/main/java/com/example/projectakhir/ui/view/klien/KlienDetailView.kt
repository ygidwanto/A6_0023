...
import com.example.projectakhir.ui.navigation.AcaraDestinasi.route
...
fun DetailView(
    ...
    Scaffold(
        ...
        topBar = {
            CustomeTopAppBar(
                title = DetailKlienDestinasi.titleRes,
...
fun ItemDetailKlien(
    ...
    Card(
        ...
        Column(
            ...
            ComponentDetailKlien(judul = "ID", isinya = klien.toString())
